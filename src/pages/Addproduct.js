...
//     onSubmit: (values) => {
//       dispatch(createProducts({...values, images}));
//       formik.resetForm();
//       setColor([]);
//       setImages([]);
//       setTimeout(() => {
...
//               checked={formik.values.isFinalSale}
//             />
//             <label htmlFor="isFinalSale" className="ml-2">This item is final sale</label>
//           </div>
//           <CustomInput
//             type="text"
...
//                     type="button"
//                     onClick={() => {
//                       const updatedImages = formik.values.images.filter((_, index) => index !== j);
//                       formik.setFieldValue('images', updatedImages);
//                     }}
//                     className="btn-close position-absolute"
//                     style={{ top: "10px", right: "10px" }}
//                   ></button>
//                   <img src={URL.createObjectURL(i)} alt="" width={200} height={200} />
//                 </div>
//               );
//             })}
//           </div>
